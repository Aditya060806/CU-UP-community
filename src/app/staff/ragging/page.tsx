                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <Badge
                            variant={
                              STATUS_COLORS[report.status] as
                                | "default"
                                | "destructive"
                                | "secondary"
                                | "outline"
                        ...
                        <p className="text-xs text-zinc-500 mt-0.5">
                          {report.location} · {report.incidentDate}{" "}
                          {report.incidentTime} · Filed{" "}
                      ...
                      <div className="flex flex-wrap gap-2">
                        {(
                          ...
                          <Button
                            ...
                            size="sm"
                            variant={
                              report.status === s ? "default" : "outline"
                            }
                          ...
                          >
                            {saving === report.id && report.status !== s
                              ? "…"
                              : s}
                          </Button>
                        ))}
