          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500">
                Your report is confidential and protected by law
              </p>
            </div>
          </div>
              ...
              <Card className="border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-xs text-green-500 mt-4">
                    You will be notified of status updates through your student
                    portal.
                  </p>
                </CardContent>
              </Card>
              ...
              <div className="flex items-center gap-2 mb-8">
                {steps.map((s, i) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-xs hidden sm:block ${i === step ? "text-red-600 font-semibold" : "text-zinc-400"}`}
                    >
                      {s}
                    </span>
                    {i < steps.length - 1 && (
                      <div
                        className={`h-px flex-1 mx-1 ${i < step ? "bg-green-400" : "bg-zinc-200 dark:bg-zinc-700"}`}
                      />
                    )}
                  </div>
                ))}
                  ...
                  {step === 0 && (
                    <Card className="border-0 shadow-sm">
                      <CardHeader>
                        ...
                        <CardDescription>
                          You can report anonymously. Your identity will not
                        ...
                        <div className="flex items-center gap-4 p-4 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-amber-50 dark:bg-amber-900/10">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-zinc-500 mt-0.5">
                              Your name will not appear in the report submitted
                              to staff
                            </p>
                          </div>
                          <Switch
                  ...
                  {step === 1 && (
                    <Card className="border-0 shadow-sm">
                      <CardHeader>
                        ...
                        <CardDescription>
                          Describe the incident as accurately as possible
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="space-y-1.5">
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                update("incidentTime", e.target.value)
                              }
                            />
                          </div>
                        </div>
                        <div className="space-y-1.5">
                          ...
                          <Input
                            placeholder="e.g. Hostel Block C, Room 204 or Main Canteen"
                            value={form.location}
                  ...
                  {step === 2 && (
                    <Card className="border-0 shadow-sm">
                      <CardHeader>
                        ...
                        <CardDescription>
                          Optional — helps investigators follow up
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        <div className="space-y-1.5">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <Textarea
                            ...
                            onChange={(e) =>
                              update("evidenceText", e.target.value)
                            }
                            rows={5}
                            className="resize-none"
                          />
                        ...
                        <div className="p-4 bg-blue-50 dark:bg-blue-900/10 rounded-xl border border-blue-100 dark:border-blue-800 text-sm text-blue-700 dark:text-blue-300">
                          Physical evidence can be submitted to the Anti-Ragging
                          Cell, Admin Block, Ground Floor, Monday–Friday
                          9am–5pm.
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-0 shadow-sm">
                      ...
                      <CardContent className="space-y-3">
                        {[
                          ...
                          <div
                            key={label}
                            className="flex gap-3 py-2 border-b border-zinc-100 dark:border-zinc-800 last:border-0"
                          >
                            <span className="text-xs text-zinc-500 w-24 shrink-0 pt-0.5">
                              {label}
                            </span>
                        ...
                        <div className="pt-2 text-xs text-zinc-400">
                          ...
                          knowledge. False reports are a violation of university
                          policy.
                        </div>
                      </CardContent>
                    </Card>
