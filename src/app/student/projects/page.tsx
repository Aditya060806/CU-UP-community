...
export default function StudentProjects() {
  ...
  const fetchRepo = useCallback(async () => {
    ...
    try {
      ...
      if (!res.ok) {
        setFetchError(data.error ?? "Failed to fetch repo");
        setFetching(false);
        return;
      }
      setRepoInfo(data);
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">
                Submit a GitHub Project
              </h1>
              <p className="text-sm text-zinc-500">
                Get your open-source work featured on the CU-UP website
              </p>
            </div>
          </div>
              ...
              <Card className="border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-green-700 dark:text-green-400">
                    <strong>{repoInfo?.name}</strong> is now pending staff
                    review. Once approved, it will appear on the public projects
                    page.
                  </p>
                  <Button
                    onClick={() => {
            ...
            <div className="space-y-6">
              ...
              <Card className="border-0 shadow-sm">
                <CardHeader>
                  ...
                  <CardDescription>
                    Paste the public GitHub repo URL and we'll auto-fetch the
                    details
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      className="bg-zinc-900 hover:bg-zinc-700 text-white gap-1.5"
                    >
                      {fetching ? (
                      ...
                      <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-1.5">
                          ...
                          <Textarea
                            ...
                            placeholder="Describe what this project does and why it's valuable..."
                          />
                        </div>
                        <div className="space-y-1.5">
                          <Label>
